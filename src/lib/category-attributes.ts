...
const VEHICLE_FIELDS: CategoryField[] = [
  ...
  { key: 'kubikaza',   label: 'Kubikaža',     type: 'number', formPage: 1, placeholder: 'npr. 1998', unit: 'ccm' },
  { key: 'snaga',      label: 'Snaga (kW / PS)', type: 'text', formPage: 1, placeholder: 'npr. 110 kW / 150 PS' },
  ...
  { key: 'brVrata',        label: 'Broj vrata',        type: 'select', formPage: 2, options: ['2/3', '4/5', '6/7'] },
  { key: 'brVlasnika',     label: 'Broj vlasnika',     type: 'select', formPage: 2, options: ['1', '2', '3', '4+'] },
