...
export const MOCK_ADMIN_PROFILE: Profile = {
  ...
  avatar_url: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?auto=format&fit=crop&q=80&w=200&h=200',
  bio: null,
  phone: null,
  email_verified: true,
  phone_verified: true,
...
export const MOCK_USERS: Profile[] = [
  {
    id: 'user_01', username: 'marko_bh', full_name: 'Marko Petrović', avatar_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200&h=200',
    bio: 'Prodajem rabljenu elektroniku', phone: '+387 61 123 456', email_verified: true, phone_verified: true, username_chosen: true, level: 3, xp: 350, total_sales: 12, total_purchases: 5,
  ...
  {
    id: 'user_02', username: 'amina_sa', full_name: 'Amina Hadžić', avatar_url: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=200&h=200',
    bio: 'Dizajnerska odjeća i aksesori', phone: null, email_verified: true, phone_verified: false, username_chosen: true, level: 5, xp: 1200, total_sales: 38, total_purchases: 15,
  ...
  {
    id: 'user_03', username: 'dejan_mo', full_name: 'Dejan Jovanović', avatar_url: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=200&h=200',
    bio: null, phone: null, email_verified: false, phone_verified: false, username_chosen: true, level: 1, xp: 20, total_sales: 1, total_purchases: 0,
  ...
  {
    id: 'user_04', username: 'lejla_tz', full_name: 'Lejla Mujić', avatar_url: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=200&h=200',
    bio: 'Knjige i vintage stvari', phone: '+387 62 789 012', email_verified: true, phone_verified: true, username_chosen: true, level: 4, xp: 700, total_sales: 22, total_purchases: 30,
  ...
  },
  {
    ...
    bio: 'BUY NOW CHEAP!!!', phone: null, email_verified: false, phone_verified: false, username_chosen: true, level: 1, xp: 0, total_sales: 0, total_purchases: 0,
  ...
  {
    id: 'user_06', username: 'emir_ze', full_name: 'Emir Begović', avatar_url: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=200&h=200',
    bio: 'Auto dijelovi originalni', phone: null, email_verified: false, phone_verified: false, username_chosen: true, level: 2, xp: 150, total_sales: 6, total_purchases: 2,
...
export const MOCK_REPORTS: (ModerationReport & {
...
})[] = [
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1696446701796-da61225697cc?auto=format&fit=crop&q=80&w=100&h=100',
  ...
  },
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=100&h=100',
  ...
  },
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1586880244406-556ebe35f282?auto=format&fit=crop&q=80&w=100&h=100',
    reported_user_name: 'dejan_mo',
    reporter_name: undefined,
  },
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&q=80&w=100&h=100',
  ...
  },
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1598575285591-ce7d11a22b8a?auto=format&fit=crop&q=80&w=100&h=100',
  ...
  },
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?auto=format&fit=crop&q=80&w=100&h=100',
    reported_user_name: 'emir_ze',
    reporter_name: undefined,
  },
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?auto=format&fit=crop&q=80&w=100&h=100',
    reported_user_name: 'marko_bh',
    reporter_name: undefined,
  },
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1606813907291-d86efa9b94db?auto=format&fit=crop&q=80&w=100&h=100',
    reported_user_name: 'dejan_mo',
    reporter_name: 'lejla_tz',
  },
  {
    ...
    product_image: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&q=80&w=100&h=100',
