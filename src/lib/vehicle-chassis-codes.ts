...
const MODEL_SHORTCUTS: Record<string, ChassisCodeEntry | ChassisCodeEntry[]> = {
  ...
  rs3: { brand: 'Audi', model: 'RS3' },
  rs4: { brand: 'Audi', model: 'RS4' },
  rs5: { brand: 'Audi', model: 'RS5' },
  rs6: { brand: 'Audi', model: 'RS6' },
  rs7: { brand: 'Audi', model: 'RS7' },
  rsq3: { brand: 'Audi', model: 'RSQ3' },
  rsq8: { brand: 'Audi', model: 'RSQ8' },
  s3: { brand: 'Audi', model: 'S3' },
  s4: { brand: 'Audi', model: 'S4' },
  s5: { brand: 'Audi', model: 'S5' },
  s6: { brand: 'Audi', model: 'S6' },
  s7: { brand: 'Audi', model: 'S7' },
  s8: { brand: 'Audi', model: 'S8' },
  sq5: { brand: 'Audi', model: 'SQ5' },
  sq7: { brand: 'Audi', model: 'SQ7' },
  sq8: { brand: 'Audi', model: 'SQ8' },
  tts: { brand: 'Audi', model: 'TTS' },
  ttrs: { brand: 'Audi', model: 'TTRS' },
  // BMW
