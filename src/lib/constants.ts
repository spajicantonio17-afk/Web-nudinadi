...
export const CATEGORIES: Category[] = [
  ...
  // ─── 2. DIJELOVI ZA VOZILA ───────────────────────────────
  {
    ...
    subCategories: [
      ...
      { name: 'Za automobile – Tuning i oprema', items: ['Bodykit i pragovi', 'Chip tuning i upravljačke jedinice (aftermarket)', 'Difuzori stražnji', 'Karbonski dijelovi', 'Krovni nosači i šine', 'Kuka za vuču / towbar', 'LED trake i dekorativna rasvjeta', 'Nosači za bicikle i skijaška oprema', 'Ostali tuning', 'Spojleri i lip spojleri', 'Sportska sjedala', 'Sportski filteri zraka', 'Sportski ispuh i down pipe', 'Sportski volan', 'Zaštitne folije i wrap'] },
      { name: 'Za automobile – Navigacija i auto akustika', items: ['Aftermarket navigacija i ekrani', 'Auto alarm i imobilajzer', 'Dash kamere', 'GPS lokatori', 'Hands-free i Bluetooth moduli', 'Pojačala', 'Radio i OEM multimedija', 'Stražnje i 360° kamere', 'Subwooferi i bass', 'Zvučnici prednji i stražnji'] },
      ...
      { name: 'Za motocikle – Karoserija i oklopi', items: ['Bočni oklopi', 'Nasloni i kutije', 'Prednja maska i oklopi', 'Prednji i stražnji blatobran', 'Rezervoar goriva', 'Stražnji oklop i sjedište'] },
      ...
      { name: 'Za motocikle – Ovjes i kočnice', items: ['Disk kočnice', 'Kočione pločice i čeljusti', 'Ležajevi kotača', 'Prednja viljuška i opruge', 'Stražnji amortizer'] },
      { name: 'Za motocikle – Felge i gume', items: ['Enduro i off-road gume', 'Ljetne / sportske gume', 'Prednje felge', 'Stražnje felge'] },
      ...
      { name: 'Za bicikle – Kotači i gume', items: ['Gume cestovne', 'Gume gravel', 'Gume MTB', 'Naplatci / felge', 'Niple i žbice', 'Prednji kotač kompletan', 'Stražnji kotač kompletan', 'Unutarnje gume i tubeless'] },
      { name: 'Za bicikle – Kočnice i mjenjači', items: ['Disk kočnice (hidrauličke/mehaničke)', 'Kazete i zvjezdice', 'Kočione pločice i obloge', 'Kočne ručice', 'Lanci', 'Naplatci single speed', 'Prednji mjenjač', 'Ručice mjenjača', 'Stražnji mjenjač / derailleur', 'V-brake kočnice'] },
      ...
      { name: 'Za bicikle – Osvjetljenje i oprema', items: ['Blatobrani', 'Košare i nosači', 'Prednja svjetla', 'Pumpe', 'Računala i brzinomjeri', 'Reflektori', 'Stražnja svjetla', 'Zaključavanja i brave'] },
