...
export const CAR_BRANDS_WITH_MODELS: VehicleBrand[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { name: 'A3', variants: ['30', '35', '40'] },
      { name: 'A4', variants: ['30', '35', '40', '45'] },
      { name: 'A5', variants: ['35', '40', '45'] },
      { name: 'A6', variants: ['40', '45', '50', '55'] },
      { name: 'A7', variants: ['45', '50', '55'] },
      { name: 'A8', variants: ['50', '55', '60'] },
      { name: 'Q2' }, { name: 'Q3', variants: ['35', '40', '45'] },
      { name: 'Q5', variants: ['40', '45', '50'] },
      { name: 'Q7', variants: ['45', '50', '55'] },
      { name: 'Q8', variants: ['50', '55'] },
      { name: 'TT' },
      { name: 'R8' },
      { name: 'S3' }, { name: 'S4' }, { name: 'S5' }, { name: 'S6' }, { name: 'S7' }, { name: 'S8' },
      { name: 'RS3' }, { name: 'RS4' }, { name: 'RS5' }, { name: 'RS6' }, { name: 'RS7' },
