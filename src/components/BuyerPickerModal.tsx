...
export default function BuyerPickerModal({ productId, sellerId, onClose, onSuccess }: BuyerPickerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-start justify-center pt-24 sm:pt-24 pb-4 px-3 sm:px-4">
      ...
      <div className="relative bg-[var(--c-card)] border border-[var(--c-border)] w-full max-w-md rounded-[10px] shadow-strong overflow-hidden animate-scaleIn max-h-[50vh] sm:max-h-[calc(100vh-7rem)] flex flex-col">
        {/* Header */}
