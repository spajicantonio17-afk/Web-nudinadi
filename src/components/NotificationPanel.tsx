...
export default function NotificationPanel({ isOpen, onClose }: NotificationPanelProps) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed top-20 right-4 z-[150] w-[280px] sm:w-[340px] max-w-[calc(100vw-32px)] max-h-[45vh] sm:max-h-[70vh] bg-[var(--c-card)] border border-[var(--c-border)] rounded-[20px] shadow-2xl overflow-hidden animate-[fadeIn_0.2s_ease-out]">
        ...
        {/* Notification List */}
        <div className="overflow-y-auto max-h-[calc(45vh-70px)] sm:max-h-[calc(70vh-70px)] no-scrollbar">
          {notifications.length > 0 ? (
