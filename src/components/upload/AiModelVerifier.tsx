...
export default function AiModelVerifier({
  ...
  return (
    ...
    >
      <div
        className={`relative w-full sm:max-w-[440px] max-h-[50vh] sm:max-h-none bg-[var(--c-card)] border border-[var(--c-border)] rounded-t-2xl sm:rounded-2xl flex flex-col overflow-hidden shadow-2xl transition-transform duration-300 ease-out ${
